...
//创建一个物体（形状）
const geometry = new THREE.BoxGeometry(70, 70, 70); //长宽高都是100的立方体
...
// 添加多个模型（添加圆形）
const geometry2 = new THREE.SphereGeometry(50, 30, 30);
...
//创建一个透视相机，1200 / 700比例是设置的渲染区尺寸 宽 / 高
const camera = new THREE.PerspectiveCamera(45, 1200 / 700, 1, 800);
//设置相机位置
...
renderer.setSize(1200, 700); //设置渲染区尺寸
